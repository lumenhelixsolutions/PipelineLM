...
async function run() {
  ...
  if (command === "login") {
    ...
    try {
      ...
      fs.writeFileSync(DEFAULT_SESSION_FILE2, JSON.stringify(authResult.storageState, null, 2));
      console.log("\nLogin successful!");
      console.log(`Session saved to: ${DEFAULT_SESSION_FILE2}`);
      console.log("\nIn your code:");
    ...
    try {
      ...
      console.log(`Session file: ${DEFAULT_SESSION_FILE2}`);
